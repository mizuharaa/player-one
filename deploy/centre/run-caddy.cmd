...
if not defined PLAYERONE_CADDY_EXE set "PLAYERONE_CADDY_EXE=C:\Tools\Caddy\caddy.exe"
"%PLAYERONE_CADDY_EXE%" run --config "deploy\centre\Caddyfile" --adapter caddyfile >> "deploy\centre\logs\caddy-%LOG_DATE%.log" 2>&1
exit /b %ERRORLEVEL%
