...
> = {
  counter: {
    ...
    today:
      'The whole counter workflow exists as API endpoints and is driven by `packages/api/bin/counter.ts`. `pnpm ingest` imports a card; the handover and session endpoints are exercised by a machine client. The BO-09 cut is deliberate; ADR 0003 records it and its trigger — a second centre, or 500 collectors, whichever comes first.',
  },
  episodes: {
