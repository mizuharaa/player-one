...
const vi = {
  ...
  'onboarding.paidTitle': 'DUYỆT XONG LÀ CÓ TIỀN',
  'onboarding.paidBody': 'Mang thẻ nhớ tới quầy. Nhân viên sẽ xem video, và bạn được trả theo từng phút hiệu quả đã duyệt.',
  ...
  'explore.availability': 'Buổi dài nhất bạn làm được',
  'explore.anyLength': 'Dài bao nhiêu cũng được',
  'explore.skills': 'Nơi bạn ghi hình được',
  'explore.savePrefs': 'Lưu tùy chọn',
  'explore.effort': 'Độ dài buổi ghi',
  'explore.effortShort': 'Ngắn',
  'explore.effortMedium': 'Vừa',
  'explore.effortLong': 'Dài',
  ...
  'profile.preferencesSub': 'Độ dài buổi ghi và nơi bạn ghi được',
...
const en: Record<MessageKey, string> = {
  ...
  'onboarding.paidTitle': 'REVIEWED, THEN PAID',
  'onboarding.paidBody': 'Hand the card in at the desk. A reviewer watches the footage and you are paid for every reviewed effective minute.',
  ...
  'explore.availability': 'Longest session you can do',
  'explore.anyLength': 'Any length',
  'explore.skills': 'Where you can record',
  'explore.savePrefs': 'Save preferences',
  'explore.effort': 'Session length',
  'explore.effortShort': 'Short',
  'explore.effortMedium': 'Medium',
  'explore.effortLong': 'Long',
  ...
  'profile.preferencesSub': 'Session length, and where you can record',
...
const zh: Record<MessageKey, string> = {
  ...
  'onboarding.paidTitle': '审核通过，就付款',
  'onboarding.paidBody': '把存储卡交到柜台。审核人员会看视频，你按审核通过的每一个有效分钟得到报酬。',
  ...
  'explore.availability': '你能做的最长时长',
  'explore.anyLength': '任何时长都行',
  'explore.skills': '你可以拍摄的地点',
  'explore.savePrefs': '保存偏好',
  'explore.effort': '录制时长',
  'explore.effortShort': '短',
  'explore.effortMedium': '中等',
  'explore.effortLong': '长',
  ...
  'profile.preferencesSub': '录制时长，以及你能拍摄的地点',
