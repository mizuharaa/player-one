...
const vi = {
  ...
  'notif.noPush': 'Bản này chưa bật thông báo đẩy. Có gì gấp, nhân viên ở quầy vẫn gọi cho bạn.',
  ...
  'notif.settingsIntro': 'Mấy mục này chưa gửi đi đâu, vì kênh gửi chưa làm xong. Bạn chọn trước, khi nào xong sẽ áp dụng.',
...
const en: Record<MessageKey, string> = {
  ...
  'notif.noPush': 'Push messages are not switched on in this build. The desk still calls you for anything urgent.',
  ...
  'notif.email': 'Email',
  'notif.push': 'Push',
  'notif.settingsIntro': 'Nothing here is sent yet, because the channel is not built. Choose what you want and it applies when it is.',
...
const zh: Record<MessageKey, string> = {
  ...
  'notif.earlier': '更早',
  'notif.settings': '通知设置',
  'notif.noPush': '这个版本还没有开启推送。有急事柜台还是会打电话给你。',
  ...
  'notif.email': '电子邮件',
  'notif.push': '推送',
  'notif.settingsIntro': '这些还没有真的发送，因为发送渠道还没做好。你先选，做好后会生效。',
