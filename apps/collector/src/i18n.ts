...
const vi = {
  ...
  'signIn.demoFilled': 'Máy chủ đang ở chế độ trình diễn nên đã điền sẵn mã. Không có tin nhắn Zalo nào được gửi.',
...
const en: Record<MessageKey, string> = {
  ...
  'signIn.demoFilled': 'The server is in demonstration mode and filled the code in. No Zalo message was sent.',
