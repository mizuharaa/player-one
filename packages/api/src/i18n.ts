...
const en = {
  ...
  'bo.collector.qualify': 'Qualify',
  'bo.collector.suspend': 'Suspend',
  ...
  'bo.device.markFaulty': 'Mark faulty',
  'bo.device.markActive': 'Back in service',
...
const zh: Record<MessageKey, string> = {
  ...
  'bo.collector.qualify': '置为合格',
  'bo.collector.suspend': '停用',
  ...
  'bo.device.bind': '绑定',
  'bo.device.unbind': '解绑',
  'bo.device.markFaulty': '标记故障',
  'bo.device.markActive': '恢复在用',
