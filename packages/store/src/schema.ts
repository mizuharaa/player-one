...
export const episodes = pgTable(
  ...
  (t) => [
     ...
     * Migration 0007 carries the other half: a trigger resets this to
 ...
 * express a trigger: `upload_batches_cloud_verify_guard` refuses to set EITHER
 * `cloud_verified_at` OR `local_cache_cleaned_at` unless the batch has at least
 * one episode and every episode on it reads `verification_state = 'verified'`
