...
export const tasks = pgTable(
  'tasks',
  {
     ...
     * (`task_claims_commitment_required`, migration 0011). The CHECK below is
 ...
 * `task_commitments_terms_gate` (migration 0011) is what proves the copy was
 ...
 * timing rules live in `task_commitments_state_transition` in migration 0011:
 ...
 * human closes it, by `task_commitments_emit_event` in migration 0011 — a
